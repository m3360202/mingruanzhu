...
const CharachterSlider: React.FC<CardProps> = ({ items, autoPlay = false }) => {
  ...
  useEffect(() => {
    ...
    const handleResize = () => {
      ...
      const calculatedWidth = Math.round((containerWidth - 48) / 4);
  ...
  return (
    <Box ref={containerRef} className="relative w-full pt-12">
      <Box
        ...
        <Box
          ...
          <Box
            ...
            style={{
              ...
              transform: `translateX(calc(-${currentIndex * (100 / visibleCards)}% + ${(100 - (100 / visibleCards) * 4) / 2}%))`
            }}>
...
export default CharachterSlider;
